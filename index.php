...
<div id="board_area"> 
  ...
  <div id="search_box">
      ...
      <thead>
		...
		<tr>
		  ...
		  <td width="500"><?php 
			...
			<a href='/shkim/page/board/read.php?idx=<?php echo $board["idx"]; ?>'><?php echo $title; }?><span class="re_ct">[<?php echo $rep_count; ?>]<?php echo $img; ?></span></a></td>
    ...
    <div id="write_btn">
      <a href="/shkim/page/board/write.php"><button>글쓰기</button></a>
    </div>
  </div>
</body>
</html>
...
>>>>>>> f6e45be3f9cf5ef7f31e33ec83ae4347f06b5160
